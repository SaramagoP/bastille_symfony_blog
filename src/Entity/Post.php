...
class Post
{
    ...
    // NOTE: This is not a mapped field of entity metadata, just a simple property. png, jpg, jpeg
    #[Assert\File(
        maxSize: '3000k',
    ...
    // private ?bool $isPublished = false; - comme ne peut pas etre null la 1er option, mais la deuxieme option c'est plus conseillée
